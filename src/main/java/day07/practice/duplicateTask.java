...
public class duplicateTask {
	...
	public duplicateTask(int id, String name, LocalDate deadline) {
		this.id = id;
		this.name = name;
		this.deadline = deadline;
	}
	...
	public static void taskRemoveDuplicate(ArrayList<duplicateTask> taskList) {
		HashSet<duplicateTask> taskone = new HashSet<duplicateTask>(taskList);
